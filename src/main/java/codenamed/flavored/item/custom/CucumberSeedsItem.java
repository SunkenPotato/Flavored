...
public class CucumberSeedsItem extends AliasedBlockItem {
    public CucumberSeedsItem(Block block, Settings settings) {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (state.isOf(Blocks.FARMLAND)) {
            world.setBlockState(pos.up(), FlavoredBlocks.CUCUMBER_BUSH.getDefaultState());
