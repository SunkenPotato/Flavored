...
public class CornSeedsItem extends AliasedBlockItem {
    public CornSeedsItem(Block block, Settings settings) {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (state.isOf(Blocks.FARMLAND)) {
            world.setBlockState(pos.up(), FlavoredBlocks.CORN_BUSH.getDefaultState());
