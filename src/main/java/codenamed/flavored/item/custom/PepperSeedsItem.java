...
public class PepperSeedsItem extends AliasedBlockItem {
    public PepperSeedsItem(Block block, Settings settings) {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (state.isOf(Blocks.FARMLAND)) {
            world.setBlockState(pos.up(), FlavoredBlocks.PEPPER_BUSH.getDefaultState());
