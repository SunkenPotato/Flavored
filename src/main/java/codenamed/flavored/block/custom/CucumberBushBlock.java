...
public class CucumberBushBlock extends SweetBerryBushBlock implements Fertilizable {

    public CucumberBushBlock(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack getPickStack(WorldView world, BlockPos pos, BlockState state) {
        return new ItemStack(FlavoredItems.CUCUMBER_SEEDS);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (!bl) {
            ...
            dropStack(world, pos, new ItemStack(FlavoredItems.CUCUMBER, j + (bl ? 1 : 0)));
