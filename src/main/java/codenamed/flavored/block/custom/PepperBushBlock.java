...
public class PepperBushBlock extends SweetBerryBushBlock implements Fertilizable {

    public PepperBushBlock(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack getPickStack(WorldView world, BlockPos pos, BlockState state) {
        return new ItemStack(FlavoredItems.PEPPER_SEEDS);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (!bl) {
            ...
            dropStack(world, pos, new ItemStack(FlavoredItems.PEPPER, j + (bl ? 1 : 0)));
