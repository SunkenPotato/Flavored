...
public class TomatoBushBlock extends SweetBerryBushBlock implements Fertilizable {
    ...
    public ItemStack getPickStack(WorldView world, BlockPos pos, BlockState state) {
        return new ItemStack(FlavoredItems.TOMATO_SEEDS);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (!bl) {
            ...
            dropStack(world, pos, new ItemStack(FlavoredItems.TOMATO, j + (bl ? 1 : 0)));
